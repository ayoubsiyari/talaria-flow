(function () {
  ...
  function uploadBox(resubmit) {
    return '<div style="margin-top:40px;padding:28px;background:#0E1017;border:1px solid rgba(255,255,255,0.08);border-radius:14px">' +
      ...
      '<div id="upload-dropzone" role="button" tabindex="0" aria-label="Upload screenshots" class="scp0" style="border:1px solid rgba(255,255,255,0.16);padding:36px 24px;text-align:center;background:#07080C;cursor:pointer;border-radius:10px">' +
      ...
      '<div dir="ltr" style="font-size:var(--fs-body);text-align:left"><strong style="font-weight:600"><span data-i18n="dashboard.dropStrong">Drop screenshots here</span></strong> <span style="color:#B7BCCB"><span data-i18n="dashboard.dropRest">or click to choose</span></span></div>' +
      '<p style="margin-top:6px;font-family:\'Geist Mono\',monospace;font-size:11.5px;letter-spacing:.04em;color:#8B90A3"><span data-i18n="dashboard.dropMeta">PNG, JPG or WEBP · up to 4 files · 5 MB each</span></p></div>' +
      '<div id="upload-files" data-upload-files style="display:none;margin-top:14px;flex-wrap:wrap;gap:8px"></div>' +
