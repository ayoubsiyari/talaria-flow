(function () {
  ...
  function uploadBox(resubmit) {
    return '<div style="margin-top:40px;padding:28px;background:#0E1017;border:1px solid rgba(255,255,255,0.08);border-radius:14px">' +
      ...
      '<div id="upload-dropzone" role="button" tabindex="0" aria-label="Upload screenshots" class="scp0" style="position:relative;border:1px solid rgba(255,255,255,0.16);padding:36px 24px;text-align:center;background:#07080C;cursor:pointer;border-radius:10px">' +
      ...
      '<div data-upload-grid style="display:none;flex-wrap:wrap;align-items:center;gap:12px;width:100%;text-align:left"></div>' +
