...
function render(t,opts){
  ...
  const logo=opts.logoUrl||(base+'assets/email-logo-2x.png');
  const ar=t.lang==='ar';
...
+'<tr><td style="padding:0 4px 20px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:middle"><a href="https://www.talaria-flow.com" style="text-decoration:none;color:'+C.text+'"><img src="'+logo+'" width="24" height="27" alt="" style="display:inline-block;vertical-align:middle;margin-right:10px"><span style="display:inline-block;vertical-align:middle;font-size:17px;font-family:'+face+'"><b>Talaria</b> <span style="color:'+C.text3+'">Flow</span></span></a></td><td align="right" style="vertical-align:middle;font-family:'+M+';font-size:11px;letter-spacing:.12em;text-transform:uppercase;color:'+C.text3+'">'+(t.eyebrow||'')+'</td></tr></table></td></tr>'
